...
- **Merging.** The agent merges its own PR once CI is green on the head commit and the
  review agent has reported no blocking finding. It never force-pushes a shared branch
