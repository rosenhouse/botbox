...
| G4 | Convergence. `ready` holds on every CR within `T_settle` of every spec change, and again once a fault stops. A controller waiting to restart after a crash has not converged. |
