...
its restart to converge. G7 notes a `deleteManaged` after one of these restarts as it does
one after a `restart`, and notes one where your controller exited, or waited to restart,
