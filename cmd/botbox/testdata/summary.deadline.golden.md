# botbox run on toy-widget dev: error

botbox v0.0.0-test ran 1 of 3 runs from seed 7 on envtest, with `--launch-arg --bug=3`. It took 58s of the --deadline of 5m0s, and exited 2.

botbox: the --deadline of 5m0s stopped the invocation after 1 of 3 runs
