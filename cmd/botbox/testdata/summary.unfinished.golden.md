...
botbox v0.0.0-test ran 2 of 3 runs from seed 7 on envtest, with `--launch-arg --bug=3 --launch-arg '--name=a b'`. It took 58s of the --deadline of 5m0s, and exited 2.
...
op 0 (create): the target is no longer running
